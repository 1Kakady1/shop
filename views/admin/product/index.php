                    ...
                    <div>
                        <select name="cat-id" class="form-control">
                            <?php foreach ($cat as $catItem): ?>
                                <option value="<?php echo $catItem['id'] ?>" <?php //if($catItem['id']== $catId){echo "selected";}?>><?php echo $catItem['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>

                    <div id="mg-bot"><button type="submit" name="sort" class="btn btn-primary">Сортировать</button></div>
