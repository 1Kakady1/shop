    ...
    <main role="main" style="margin-top: -0.6vw;">
      ...
      <div class="jumbotron" id="cont-w" style="background: url(/template/images/background-news.jpg);background-size: 100% 100%;">
        <div class="container">
          ...
          <p><a class="btn btn-primary btn-lg" href="/news/<?php echo $newsList[$randNewsId[0]]['id']?>" role="button">Подробнее »</a></p>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <?php foreach ($newsList as $newsItem): ?>
          <div class="col-md-4">
            ...
            <p><a class="btn btn-secondary" href="/news/<?php echo $newsItem['id'] ?>" role="button">ПосмотретьПосмотреть »</a></p>
          </div>
